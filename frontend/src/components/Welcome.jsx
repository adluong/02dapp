...
const Welcome = () => {
	...
	const handleSubmit = (e) => {
		...
		e.preventDefault(); //prevent a page from reloading after submiting a form
			...
			<div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-20 px-4">
				<div className="flex flex-1 justify-start flex-col mf:mr-10">
					...
					<div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
						<div className={`rounded-tl-2xl ${commonStyles}`}>Cell 1</div>
						<div className={`rounded-tc-2xl ${commonStyles}`}>Cell 2</div>
						<div className={`rounded-tr-2xl ${commonStyles}`}>Cell 3</div>
						<div className={`rounded-bl-2xl ${commonStyles}`}>Cell 4</div>
						<div className={`rounded-bc-2xl ${commonStyles}`}>Cell 5</div>
						<div className={`rounded-br-2xl ${commonStyles}`}>Cell 6</div>
					</div>
				</div>
